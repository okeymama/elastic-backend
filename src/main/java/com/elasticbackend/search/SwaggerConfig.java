 ...
 * springfox.documentation.builders.ResponseMessageBuilder; import
 * springfox.documentation.service.ApiInfo; import
 * springfox.documentation.service.Contact; import
 * springfox.documentation.service.ResponseMessage; import
 ...
 * Docket(DocumentationType.SWAGGER_2).groupName("business").apiInfo(apiInfo()).
 * select() .apis(RequestHandlerSelectors.basePackage(
 * "com.elasticbackend.search.controller"))
 ...
 * 
 * private List<ResponseMessage> getGlobalDefaults() { return Arrays.asList(new
 * ResponseMessageBuilder().code(404).message("Not Found").build()); }
 * 
 * private ApiInfo apiInfo() { return new
 * ApiInfoBuilder().title("Elastic Backend") .description("Circular API")
 * .contact(new Contact("Okey Mama", "",
 * "chandanchaubey@hotmail.com")).license("License")
